...
ENVIRONMENT_PRESETS = {
    "baseline": {
        "sun_intensity": 8.5,
        "solar_efficiency": 3.0,
        "triat_costmultiplier": 1.5,
        "defence_cost_multipliar": 3.0,
        "invasiveness_cost_multipliar": 1.3,
        "parasitism_cost_multiplier": 2.0,
        "base_energyconsumption": 0.55,
        "spread_energy_threshhold": initial_energy * 1.4,
    ...
    "symbiosis_soft_competition": {
        ...
        "triat_costmultiplier": 1.4,
        "defence_cost_multipliar": 2.8,
        "invasiveness_cost_multipliar": 1.2,
        ...
        "parasitism_flat_drain": 0.6,
        "tau": 0.58,
        "alpha": 1.35,
        "aggresion_reward": 0.04,
        "defense_cost": 0.008,
        "K_nutrient": 7.0,
        "nutrient_regen_rate": 0.42,
        "nutrient_from_death_ratio": 0.10,
        "initial_invasiveness_range": (0.06, 0.40),
        "initial_mutation_rate_range": (0.04, 0.14),
        "initial_defense_range": (0.18, 0.90),
        "initial_offspring_fraction_range": (0.08, 0.42),
        "initial_photosynthesis_range": (0.38, 0.92),
        "initial_parasitism_range": (0.02, 0.28),
        "photo_parasite_tradeoff": 0.60,
    ...
    "symbiosis_patchy": {
        "sun_intensity": 7.8,
        "solar_efficiency": 2.6,
        "triat_costmultiplier": 1.6,
        "defence_cost_multipliar": 3.2,
        "invasiveness_cost_multipliar": 1.4,
        "parasitism_cost_multiplier": 2.1,
        "base_energyconsumption": 0.60,
        "spread_energy_threshhold": initial_energy * 1.55,
        "invasiveness_bonus_multipliar": 0.0023,
        "parasitism_flat_drain": 0.95,
        "tau": 0.55,
        "alpha": 1.55,
        "aggresion_reward": 0.06,
        "defense_cost": 0.009,
        ...
        "initial_invasiveness_range": (0.10, 0.65),
        "initial_mutation_rate_range": (0.05, 0.20),
        "initial_defense_range": (0.10, 0.78),
        "initial_offspring_fraction_range": (0.08, 0.44),
        "initial_photosynthesis_range": (0.22, 0.82),
    ...
    "symbiosis_tense": {
        ...
        "triat_costmultiplier": 1.7,
        "defence_cost_multipliar": 3.4,
        "invasiveness_cost_multipliar": 1.5,
        "parasitism_cost_multiplier": 2.3,
        "base_energyconsumption": 0.62,
        "spread_energy_threshhold": initial_energy * 1.6,
        ...
        "initial_mutation_rate_range": (0.05, 0.21),
    ...
    "earth_like": {
        "sun_intensity": 9.4,
        "solar_efficiency": 3.3,
        "triat_costmultiplier": 1.4,
        "defence_cost_multipliar": 2.9,
        "invasiveness_cost_multipliar": 1.2,
        "parasitism_cost_multiplier": 1.8,
        "base_energyconsumption": 0.50,
        "spread_energy_threshhold": initial_energy * 1.45,
        "invasiveness_bonus_multipliar": 0.0019,
        ...
        "initial_invasiveness_range": (0.12, 0.62),
        "initial_mutation_rate_range": (0.04, 0.18),
        "initial_defense_range": (0.16, 0.85),
        "initial_offspring_fraction_range": (0.08, 0.48),
        "initial_photosynthesis_range": (0.34, 0.90),
    ...
    "mars_harsh": {
        "sun_intensity": 3.4,
        "solar_efficiency": 2.0,
        "triat_costmultiplier": 1.5,
        "defence_cost_multipliar": 3.2,
        "invasiveness_cost_multipliar": 1.3,
        "parasitism_cost_multiplier": 1.9,
        "base_energyconsumption": 0.45,
        "spread_energy_threshhold": initial_energy * 2.2,
        "invasiveness_bonus_multipliar": 0.0012,
        ...
        "defense_cost": 0.012,
        "K_nutrient": 9.0,
        "nutrient_regen_rate": 0.24,
        "nutrient_from_death_ratio": 0.05,
        "initial_invasiveness_range": (0.06, 0.28),
        "initial_mutation_rate_range": (0.03, 0.12),
        "initial_defense_range": (0.10, 0.60),
        "initial_offspring_fraction_range": (0.03, 0.14),
        "initial_photosynthesis_range": (0.25, 0.75),
        "initial_parasitism_range": (0.01, 0.22),
        "photo_parasite_tradeoff": 0.35,
        "photo_invasive_tradeoff": 0.18,
        "defense_invasive_tradeoff": 0.14,
    },
    ...
    "deep_sea": {
        "sun_intensity": 1.8,
        "solar_efficiency": 1.35,
        "triat_costmultiplier": 1.3,
        "defence_cost_multipliar": 2.6,
        "invasiveness_cost_multipliar": 0.9,
        "parasitism_cost_multiplier": 1.4,
        "base_energyconsumption": 0.30,
        ...
        "defense_cost": 0.006,
        "K_nutrient": 3.2,
        "nutrient_regen_rate": 1.10,
        "nutrient_from_death_ratio": 0.20,
        "initial_invasiveness_range": (0.01, 0.16),
        "initial_mutation_rate_range": (0.05, 0.20),
        "initial_defense_range": (0.06, 0.45),
        "initial_offspring_fraction_range": (0.02, 0.12),
        "initial_photosynthesis_range": (0.12, 0.45),
        "initial_parasitism_range": (0.01, 0.25),
    ...
    "proxima_b": {
        "sun_intensity": 3.9,
        "solar_efficiency": 1.95,
        "triat_costmultiplier": 1.75,
        "defence_cost_multipliar": 3.9,
        "invasiveness_cost_multipliar": 1.6,
        "parasitism_cost_multiplier": 2.3,
        "base_energyconsumption": 0.50,
        ...
        "initial_offspring_fraction_range": (0.05, 0.26),
        "initial_photosynthesis_range": (0.20, 0.71),
        "initial_parasitism_range": (0.03, 0.41),
...
def calculate_parasitism(parasite_idx):
    ...
    parasite_trait = parasitism_rate[parasite_idx]
    if parasite_trait <= 0:
        return 0
    ...
    for n_tile in neighbors:
        ...
        base_drain_percent = parasite_trait * 0.2
        base_flat_drain = parasite_trait * parasitism_flat_drain
...
def get_current_tile_species():
    ...
    for tile_idx, org_idx in spatial_occupancy.items():
        if Alive[org_idx]:
...
def compute_observations(living, include_trait_corr=True):
    ...
    if include_trait_corr:
        corr = calculate_trait_correlation(living)
    else:
        corr = history_trait_corr[-1] if history_trait_corr else np.eye(4, dtype=float)
...
def cleanup_extinct_lineage():
    living_species = set(species_id[i] for i in alive_indices)
...
def collect_statistics():
    ...
    living = list(alive_indices)
    living_count = len(living)
    history_population.append(living_count)
    ...
    total_age = 0.0
    total_invasive = 0.0
    total_parasitism = 0.0

    for i in living:
        total_energy += Energy[i]
        total_photo += photosynthetic_ratio[i]
        total_defense += home_court_potency[i]
        total_age += Age[i]
        total_invasive += invasiveness[i]
        total_parasitism += parasitism_rate[i]

    history_total_energy.append(total_energy)
    if living_count:  # avoid division by zero
        history_avg_photosynthesis.append(total_photo / living_count)
        history_avg_defense.append(total_defense / living_count)
        history_avg_age.append(total_age / living_count)
        history_avg_invasiveness.append(total_invasive / living_count)
        history_avg_parasitism.append(total_parasitism / living_count)
    else:
...
STARTUP_REPLAY_PATH = None  # Optional .pkl path. None means load newest run file.
